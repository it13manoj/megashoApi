...
var aController = require("../Controllers/AboutControllers");
...
var aModel = require('../Models/AboutsMode');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return regeneratorRuntime.awrap(aModel.findById(req.params.partnerId).then(function (_ref) {
...
Routes.post("/create", imageUpload.single('image'), resize, aController.create);
Routes.put("/edit/:aid", imageUpload.single('image'), resize, aController.edit);
