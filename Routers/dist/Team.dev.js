...
var tController = require("../Controllers/TeamControlle");
...
var tModel = require('../Models/TeamModal');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return regeneratorRuntime.awrap(tModel.findById(req.params.partnerId).then(function (_ref) {
