...
var uController = require("../Controllers/HomeController");
...
var partnerModel = require('../Models/HomeModal');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return regeneratorRuntime.awrap(partnerModel.findById(req.params.partnerId).then(function (_ref) {
...
Routes.post("/create", imageUpload.single('image'), resize, uController.create);
Routes.put("/edit/:hid", imageUpload.single('image'), resize, uController.edit);
